...
export const links: Route.LinksFunction = () => [
  { rel: "icon", href: "/favicon-al.svg", type: "image/svg+xml" },
  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <title>The Acquisition Journey</title>
        <meta name="description" content="Documenting my path to business ownership" />
        <Meta />
        <Links />
      </head>
